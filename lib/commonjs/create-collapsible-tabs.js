...
function CollapsibleHeaderTabView(_ref) {
  ...
  const scrollToPosition = (0, _react.useCallback)(position => {
    var _gestureContainerRef$2;
    (_gestureContainerRef$2 = gestureContainerRef.current) === null || _gestureContainerRef$2 === void 0 ? void 0 : _gestureContainerRef$2.scrollToPosition(position);
  }, []);
